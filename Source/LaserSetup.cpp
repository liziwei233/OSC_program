...
void LaserSetup::LaserAnalysis()
{
    ...
    for(int i = 0; i < NofDetectors; ++i)
    {
        ...
        if(Detectors.at(i)->type > 0)
        {
            ...
            Detectors.at(i)->FilterWaveformFFT(0, 4096, 2.5);
...
void LaserSetup::Dump()
{
    TFile dumpfile("laser_dumpfile.root","recreate");
...
void LaserSetup::SetWaveformToAverage(AverageTool &aver)
{
    ScaleAndShiftTimes();
    for(int i = 0; i < NofDetectors; ++i)
    {
